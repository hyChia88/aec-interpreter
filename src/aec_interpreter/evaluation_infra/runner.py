...
from aec_interpreter.common.guid import extract_guids_from_text
from aec_interpreter.common.evaluation import compute_gt_matches, format_context_string

# RQ2 imports (optional - only used if rq2_schema is available)
try:
    from aec_interpreter.schema.extract_final_json import extract_final_json
