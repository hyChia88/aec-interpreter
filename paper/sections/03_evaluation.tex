...
concrete (Figure~\ref{fig:triage}): over the same final candidate pools, the expected number of
candidates a coordinator must inspect falls from a median 38 under an unranked-pool review to
0.5 under a perfect address --- with 15 seconds per inspection an explicit proxy assumption, not
a user-study or observed field-labor result.
...
\begin{figure}[ht]
  ...
  median 38 (unranked final pool) to 0.5 (perfect address); the realized specialist sits between, with
