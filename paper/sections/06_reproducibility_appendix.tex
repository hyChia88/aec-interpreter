...
\begin{table}[ht]
  ...
  \begin{tabular}{lp{0.62\linewidth}}
    ...
    Adapter family & LoRA adapters; the strongest reported G-series configurations use rank 32 and learning rate $1\times10^{-4}$. Earlier ablations used rank 16 or rank 32 depending on the experiment. \\
