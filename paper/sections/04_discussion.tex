...
addressable subset, at rank 1 in 58.9\% of cases end-to-end (73.4\% when the system is allowed to defer
...
${\sim}20\% \to 73.4\%$), not a precise optimal threshold. \emph{Class coverage:} the realized address
