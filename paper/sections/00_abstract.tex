...
subset ($n=35$) from a 6.6\% floor to \textbf{67.6\%}; its confidence passes an ECE calibration gate
(AUROC 0.80); and deferring the least-confident fifth raises answered-set Top-1 to \textbf{80.6\%}. The result is an auditable spatial multimodal grounding layer for AEC: ontology is
